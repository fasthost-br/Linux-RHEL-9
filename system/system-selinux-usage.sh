...
## 
## [EN] Title: SELinux Usage Guide for AlmaLinux/Rockylinux/CentOS 9.x
## [PT] Título: Guia de Utilização do SELinux para AlmaLinux/Rockylinux/CentOS 9.x
##
...
semanage port --add --type ssh_port_t --proto tcp 7858
    # Add new SSH Port (7858) into SELinux to not get blocked when change.
